...
- **`field`** `series string` (optional) — Input string. Possible values include: [dividends.net](../../constants/dividends/net.md), [dividends.gross](../../constants/dividends/gross.md). Default value is [dividends.gross](../../constants/dividends/gross.md).
